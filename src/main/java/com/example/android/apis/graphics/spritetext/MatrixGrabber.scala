...
class MatrixGrabber {
  var mModelView: Array[Float] = null
  var mProjection: Array[Float] = null

  mModelView = new Array[Float](16)
  mProjection = new Array[Float](16)
  /**
  ...
  private def getMatrix(gl: GL10, mode: Int, mat: Array[Float]) {
    val gl2: MatrixTrackingGL = gl.asInstanceOf[MatrixTrackingGL]
