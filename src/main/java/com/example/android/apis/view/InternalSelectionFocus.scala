...
class InternalSelectionFocus extends Activity {
  protected override def onCreate(savedInstanceState: Bundle) {
    ...
    val params: LinearLayout.LayoutParams = new LinearLayout.LayoutParams(0, ViewGroup.LayoutParams.MATCH_PARENT, 1)
    val leftColumn: InternalSelectionView = new InternalSelectionView(this, 5, "left column")
    leftColumn.setLayoutParams(params)
    leftColumn.setPadding(10, 10, 10, 10)
    layout.addView(leftColumn)
    val middleColumn: InternalSelectionView = new InternalSelectionView(this, 5, "middle column")
    middleColumn.setLayoutParams(params)
    middleColumn.setPadding(10, 10, 10, 10)
    layout.addView(middleColumn)
    val rightColumn: InternalSelectionView = new InternalSelectionView(this, 5, "right column")
