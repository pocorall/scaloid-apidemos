...
class List6 extends ListActivity {
   ...
   *
   */
  private class SpeechView(context: Context, title: String, dialogue: String, expanded: Boolean) extends LinearLayout(context) {
